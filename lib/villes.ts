...
export const villes: Ville[] = [
  ...
  { slug: "carros", nom: "Carros", tier: 3,
    ...
    habitat: "Entre village perché historique et zone résidentielle plus récente, Carros profite d'une isolation thermique qui réduit nettement les besoins de chauffage hivernal en vallée." },
]
