...
export const villes: Ville[] = [
  ...
  { slug: "antibes", nom: "Antibes", tier: 1,
    ...
    climat: "Antibes bénéficie d'un climat méditerranéen doux. Une bonne isolation thermique permet d'y limiter efficacement les besoins de chauffage hivernal comme de rafraîchissement estival.",
  ...
  { slug: "menton", nom: "Menton", tier: 1,
    ...
    climat: "Menton bénéficie du micro-climat le plus doux de toute la Côte d'Azur, abrité par les montagnes environnantes. Cette douceur permet de limiter fortement les besoins énergétiques d'un logement correctement isolé.",
  ...
  { slug: "mandelieu-la-napoule", nom: "Mandelieu-la-Napoule", tier: 2,
    ...
    climat: "Entre golfs et bord de mer, Mandelieu-la-Napoule bénéficie d'un climat doux toute l'année, ce qui rend l'isolation thermique particulièrement rentable sur le long terme.",
  ...
  { slug: "sophia-antipolis", nom: "Sophia-Antipolis", tier: 2,
    ...
    habitat: "Les constructions plus récentes de la technopole profitent grandement d'une isolation thermique ciblée pour optimiser leur classe énergétique sans travaux excessifs." },
